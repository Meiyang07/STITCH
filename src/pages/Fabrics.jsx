...
const filterDefs = {
  material: ['All','Wool','Cotton','Linen','Cashmere','Velvet','Wool Blend'],
  pattern: ['All','Solid','Pinstripe','Windowpane','Checks','Herringbone'],
...
export default function Fabrics() {
  ...
  return <>
    <section className="pb-20 pt-36 sm:pb-28 sm:pt-44"><div className="container-lux"><SectionHeader label="FABRIC COLLECTION" title="Cloth Sets The Character" copy="Browse representative cloth options by material, pattern and season. Final availability, handle and suitability are confirmed during consultation." />
