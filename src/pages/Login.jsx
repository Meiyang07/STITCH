      ...
      <div className="grid min-h-[calc(100vh-76px)] lg:grid-cols-2">
        <div className="relative hidden overflow-hidden bg-charcoal lg:block">
          ...
          <div className="absolute inset-x-0 bottom-0 p-12 text-white xl:p-16">
            ...
            <p className="mt-5 max-w-lg font-serif text-5xl leading-[.98]">Keep the practical details in one place.</p>
            <p className="mt-5 max-w-md text-sm leading-7 text-white/60">Saved measurements, wishlist items and profile details stay connected to your browser profile.</p>
          </div>
        </div>
        ...
        <div className="flex items-center px-5 py-14 sm:px-10 lg:px-16 xl:px-24">
          <div className="mx-auto w-full max-w-lg">
            ...
            <p className="mt-5 max-w-md text-sm leading-7 text-muted">Sign in to return to your profile, saved measurements and wishlist.</p>
            ...
            <form onSubmit={submit} className="mt-10 space-y-6 border-t border-black/15 pt-8">
              ...
              <label className="block">
                <span className="mb-2 flex items-center gap-2 text-[10px] uppercase tracking-[.16em] text-muted"><LockKeyhole size={14}/> Password</span>
            ...
            <div className="mt-8 border-t border-black/10 pt-6 text-sm text-muted">
              New to Stitch? <Link to="/signup" className="border-b border-gold pb-1 text-ink hover:text-gold">Create an account</Link>
            </div>
            <p className="mt-5 text-[11px] leading-5 text-muted/70">Prototype note: account data is stored locally on this device rather than on a secure server.</p>
          </div>
        </div>
      </div>
    </section>
